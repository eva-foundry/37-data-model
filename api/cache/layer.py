...
class CacheLayer:
    ...
    async def stats(self) -> dict:
        ...
        overall_hit_rate = (self.total_hits / total_requests * 100) if total_requests > 0 else 0
...
def create_cache_layer(redis_client=None, cosmos_store=None, 
                      ttl_memory_seconds=120, ttl_redis_seconds=1800) -> CacheLayer:
