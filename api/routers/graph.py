...
EDGE_TYPES: list[EdgeTypeMeta] = [
    ...
    # ── Execution Engine Edges (L52-L56) Session 41 Part 10 ──
    EdgeTypeMeta(
        edge_type="executes_for",
        from_layer="work_execution_units",
        to_layer="projects",
        via_field="project_id",
        cardinality="many-to-one",
        description="Work unit executes for project"),
    EdgeTypeMeta(
        edge_type="executes_wbs",
        from_layer="work_execution_units",
        to_layer="wbs",
        via_field="wbs_id",
        cardinality="many-to-one",
        description="Work unit executes WBS node"),
    EdgeTypeMeta(
        edge_type="executes_in_sprint",
        from_layer="work_execution_units",
        to_layer="sprints",
        via_field="sprint_id",
        cardinality="many-to-one",
        description="Work unit executes in sprint"),
    EdgeTypeMeta(
        edge_type="assigned_to_agent",
        from_layer="work_execution_units",
        to_layer="agents",
        via_field="assigned_to_id",
        cardinality="many-to-one",
        description="Work unit assigned to agent (polymorphic: also cp_agents, personas)"),
    EdgeTypeMeta(
        edge_type="governed_by_workflow",
        from_layer="work_execution_units",
        to_layer="cp_workflows",
        via_field="workflow_id",
        cardinality="many-to-one",
        description="Work unit governed by control plane workflow"),
    EdgeTypeMeta(
        edge_type="governed_by_policy",
        from_layer="work_execution_units",
        to_layer="cp_policies",
        via_field="policy_refs",
        cardinality="many-to-many",
        description="Work unit constrained by control plane policies"),
    EdgeTypeMeta(
        edge_type="produces_evidence",
        from_layer="work_execution_units",
        to_layer="evidence",
        via_field="evidence_ids",
        cardinality="many-to-many",
        description="Work unit produces evidence artifacts"),
    EdgeTypeMeta(
        edge_type="step_of",
        from_layer="work_step_events",
        to_layer="work_execution_units",
        via_field="work_unit_id",
        cardinality="many-to-one",
        description="Step event belongs to work unit (CASCADE on delete)"),
    EdgeTypeMeta(
        edge_type="decided_during",
        from_layer="work_decision_records",
        to_layer="work_execution_units",
        via_field="work_unit_id",
        cardinality="many-to-one",
        description="Decision made during work unit execution (CASCADE on delete)"),
    EdgeTypeMeta(
        edge_type="outcome_of",
        from_layer="work_outcomes",
        to_layer="work_execution_units",
        via_field="work_unit_id",
        cardinality="many-to-one",
        description="Outcome delivered by work unit (CASCADE on delete)"),
    EdgeTypeMeta(
        edge_type="step_references_trace",
        from_layer="work_step_events",
        to_layer="traces",
        via_field="trace_ids",
        cardinality="many-to-many",
    ...
    # ── Phase 5: Breach Remediation & Lifecycle (L67-L70) ──────────────
    EdgeTypeMeta(
        edge_type="breaches_slo",
        from_layer="work_service_breaches",
        to_layer="work_service_level_objectives",
        via_field="slo_id",
        cardinality="many-to-one",
        description="Breach of SLO (RESTRICT on SLO delete)"),
    EdgeTypeMeta(
        edge_type="breach_for_service",
        from_layer="work_service_breaches",
        to_layer="work_factory_services",
        via_field="service_id",
        cardinality="many-to-one",
        description="Breach for service (RESTRICT on service delete)"),
    EdgeTypeMeta(
        edge_type="breach_affects_requests",
        from_layer="work_service_breaches",
        to_layer="work_service_requests",
        via_field="affected_requests",
        cardinality="many-to-many",
        description="Requests affected by breach"),
    EdgeTypeMeta(
        edge_type="breach_failed_runs",
        from_layer="work_service_breaches",
        to_layer="work_service_runs",
        via_field="failed_runs",
        cardinality="many-to-many",
        description="Failed runs contributing to breach"),
    EdgeTypeMeta(
        edge_type="remediates_breach",
        from_layer="work_service_remediation_plans",
        to_layer="work_service_breaches",
        via_field="breach_id",
        cardinality="many-to-one",
        description="Remediation plan for breach (CASCADE on breach delete)"),
    EdgeTypeMeta(
        edge_type="remediation_for_service",
        from_layer="work_service_remediation_plans",
        to_layer="work_factory_services",
        via_field="service_id",
        cardinality="many-to-one",
        description="Remediation for service (RESTRICT on service delete)"),
    EdgeTypeMeta(
        edge_type="remediation_work",
        from_layer="work_service_remediation_plans",
        to_layer="work_execution_units",
        via_field="work_unit_id",
        cardinality="many-to-one",
        description="Work unit executing remediation (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="revalidates_breach",
        from_layer="work_service_revalidation_results",
        to_layer="work_service_breaches",
        via_field="breach_id",
        cardinality="many-to-one",
        description="Revalidation for breach (CASCADE on breach delete)"),
    EdgeTypeMeta(
        edge_type="revalidates_remediation",
        from_layer="work_service_revalidation_results",
        to_layer="work_service_remediation_plans",
        via_field="remediation_plan_id",
        cardinality="many-to-one",
        description="Revalidation of remediation plan (CASCADE on plan delete)"),
    EdgeTypeMeta(
        edge_type="revalidation_samples",
        from_layer="work_service_revalidation_results",
        to_layer="work_service_runs",
        via_field="sample_run_ids",
        cardinality="many-to-many",
        description="Runs sampled for revalidation measurement"),
    EdgeTypeMeta(
        edge_type="revalidation_learning",
        from_layer="work_service_revalidation_results",
        to_layer="work_learning_feedback",
        via_field="learning_feedback_id",
        cardinality="many-to-one",
        description="Learning captured from remediation (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="lifecycle_for_service",
        from_layer="work_service_lifecycle",
        to_layer="work_factory_services",
        via_field="service_id",
        cardinality="many-to-one",
        description="Lifecycle event for service (CASCADE on service delete)"),
    EdgeTypeMeta(
        edge_type="lifecycle_work",
        from_layer="work_service_lifecycle",
        to_layer="work_execution_units",
        via_field="work_unit_id",
        cardinality="many-to-one",
        description="Work unit executing lifecycle event (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="lifecycle_breach_driven",
        from_layer="work_service_lifecycle",
        to_layer="work_service_breaches",
        via_field="breach_id",
        cardinality="many-to-one",
        description="Lifecycle event triggered by breach (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="lifecycle_remediation_driven",
        from_layer="work_service_lifecycle",
        to_layer="work_service_remediation_plans",
        via_field="remediation_plan_id",
        cardinality="many-to-one",
        description="Lifecycle event part of remediation (SET_NULL)"),

    # ── Phase 6: Strategy & Portfolio (L71-L75) ─────────────────────────
    EdgeTypeMeta(
        edge_type="portfolio_services",
        from_layer="work_factory_portfolio",
        to_layer="work_factory_services",
        via_field="service_ids",
        cardinality="many-to-many",
        description="Services in portfolio"),
    EdgeTypeMeta(
        edge_type="portfolio_roadmaps",
        from_layer="work_factory_portfolio",
        to_layer="work_factory_roadmaps",
        via_field="roadmap_ids",
        cardinality="many-to-many",
        description="Strategic roadmaps for portfolio"),
    EdgeTypeMeta(
        edge_type="portfolio_investments",
        from_layer="work_factory_portfolio",
        to_layer="work_factory_investments",
        via_field="active_investment_ids",
        cardinality="many-to-many",
        description="Active investments in portfolio"),
    EdgeTypeMeta(
        edge_type="portfolio_governance",
        from_layer="work_factory_portfolio",
        to_layer="work_factory_governance",
        via_field="governance_policy_ids",
        cardinality="many-to-many",
        description="Governance policies for portfolio"),
    EdgeTypeMeta(
        edge_type="roadmap_for_portfolio",
        from_layer="work_factory_roadmaps",
        to_layer="work_factory_portfolio",
        via_field="portfolio_id",
        cardinality="many-to-one",
        description="Roadmap belongs to portfolio (RESTRICT on delete)"),
    EdgeTypeMeta(
        edge_type="roadmap_target_capabilities",
        from_layer="work_factory_roadmaps",
        to_layer="work_factory_capabilities",
        via_field="initiatives[].target_capability_ids",
        cardinality="many-to-many",
        description="Capabilities targeted by roadmap initiatives"),
    EdgeTypeMeta(
        edge_type="roadmap_target_services",
        from_layer="work_factory_roadmaps",
        to_layer="work_factory_services",
        via_field="initiatives[].target_service_ids",
        cardinality="many-to-many",
        description="Services targeted by roadmap initiatives"),
    EdgeTypeMeta(
        edge_type="roadmap_milestones",
        from_layer="work_factory_roadmaps",
        to_layer="milestones",
        via_field="initiatives[].milestone_ids",
        cardinality="many-to-many",
        description="Milestones for roadmap initiatives"),
    EdgeTypeMeta(
        edge_type="investment_for_portfolio",
        from_layer="work_factory_investments",
        to_layer="work_factory_portfolio",
        via_field="portfolio_id",
        cardinality="many-to-one",
        description="Investment belongs to portfolio (RESTRICT on delete)"),
    EdgeTypeMeta(
        edge_type="investment_for_roadmap",
        from_layer="work_factory_investments",
        to_layer="work_factory_roadmaps",
        via_field="roadmap_id",
        cardinality="many-to-one",
        description="Investment supports roadmap (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="investment_target_capabilities",
        from_layer="work_factory_investments",
        to_layer="work_factory_capabilities",
        via_field="target_capability_ids",
        cardinality="many-to-many",
        description="Capabilities being created/enhanced"),
    EdgeTypeMeta(
        edge_type="investment_target_services",
        from_layer="work_factory_investments",
        to_layer="work_factory_services",
        via_field="target_service_ids",
        cardinality="many-to-many",
        description="Services being created/enhanced"),
    EdgeTypeMeta(
        edge_type="investment_work",
        from_layer="work_factory_investments",
        to_layer="work_execution_units",
        via_field="work_unit_ids",
        cardinality="many-to-many",
        description="Work units executing investment"),
    EdgeTypeMeta(
        edge_type="investment_evidence",
        from_layer="work_factory_investments",
        to_layer="evidence",
        via_field="evidence_ids",
        cardinality="many-to-many",
        description="Supporting evidence for investment"),
    EdgeTypeMeta(
        edge_type="metric_for_portfolio",
        from_layer="work_factory_metrics",
        to_layer="work_factory_portfolio",
        via_field="portfolio_id",
        cardinality="many-to-one",
        description="Metric scoped to portfolio (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="metric_for_service",
        from_layer="work_factory_metrics",
        to_layer="work_factory_services",
        via_field="service_id",
        cardinality="many-to-one",
        description="Metric scoped to service (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="metric_for_capability",
        from_layer="work_factory_metrics",
        to_layer="work_factory_capabilities",
        via_field="capability_id",
        cardinality="many-to-one",
        description="Metric scoped to capability (SET_NULL)"),
    EdgeTypeMeta(
        edge_type="metric_breaches",
        from_layer="work_factory_metrics",
        to_layer="work_service_breaches",
        via_field="breach_ids",
        cardinality="many-to-many",
        description="Breaches contributing to metric degradation"),
    EdgeTypeMeta(
        edge_type="metric_governance",
        from_layer="work_factory_metrics",
        to_layer="work_factory_governance",
        via_field="related_governance_policy_ids",
        cardinality="many-to-many",
        description="Governance policies governing metric"),
    EdgeTypeMeta(
        edge_type="metric_evidence",
        from_layer="work_factory_metrics",
        to_layer="evidence",
        via_field="evidence_ids",
        cardinality="many-to-many",
        description="Supporting evidence for metric"),
    EdgeTypeMeta(
        edge_type="governance_for_portfolios",
        from_layer="work_factory_governance",
        to_layer="work_factory_portfolio",
        via_field="portfolio_ids",
        cardinality="many-to-many",
        description="Portfolios where policy applies"),
    EdgeTypeMeta(
        edge_type="governance_for_services",
        from_layer="work_factory_governance",
        to_layer="work_factory_services",
        via_field="service_ids",
        cardinality="many-to-many",
        description="Services where policy applies"),
    EdgeTypeMeta(
        edge_type="governance_for_capabilities",
        from_layer="work_factory_governance",
        to_layer="work_factory_capabilities",
        via_field="capability_ids",
        cardinality="many-to-many",
        description="Capabilities where policy applies"),
    EdgeTypeMeta(
        edge_type="governance_cp_policies",
        from_layer="work_factory_governance",
        to_layer="cp_policies",
        via_field="related_cp_policy_ids",
        cardinality="many-to-many",
        description="Related control plane policies"),
    EdgeTypeMeta(
        edge_type="governance_evidence",
        from_layer="work_factory_governance",
        to_layer="evidence",
        via_field="evidence_ids",
        cardinality="many-to-many",
        description="Policy documentation and audit reports"),
]
