/**
 * L88CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L88 (l88)
 * Generated: 2026-03-13T07:20:29.3349897-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l88 records with validation and error handling.
 * 
 * Features:
...
import { createL88Record } from '@api/l88Api';
import type { L88Record, CreateL88RecordInput } from '@/types/l88';

interface L88CreateFormProps {
...
export const L88CreateForm: React.FC<L88CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l88.create_form');

  const [formData, setFormData] = useState<Partial<CreateL88RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL88Record(formData as CreateL88RecordInput);
      onSuccess(record);
    } catch (error) {
