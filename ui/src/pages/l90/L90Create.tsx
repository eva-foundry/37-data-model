/**
 * L90CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L90 (l90)
 * Generated: 2026-03-13T07:20:29.5354668-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l90 records with validation and error handling.
 * 
 * Features:
...
import { createL90Record } from '@api/l90Api';
import type { L90Record, CreateL90RecordInput } from '@/types/l90';

interface L90CreateFormProps {
...
export const L90CreateForm: React.FC<L90CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l90.create_form');

  const [formData, setFormData] = useState<Partial<CreateL90RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL90Record(formData as CreateL90RecordInput);
      onSuccess(record);
    } catch (error) {
