/**
 * L86CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L86 (l86)
 * Generated: 2026-03-13T07:20:29.2088995-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l86 records with validation and error handling.
 * 
 * Features:
...
import { createL86Record } from '@api/l86Api';
import type { L86Record, CreateL86RecordInput } from '@/types/l86';

interface L86CreateFormProps {
...
export const L86CreateForm: React.FC<L86CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l86.create_form');

  const [formData, setFormData] = useState<Partial<CreateL86RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL86Record(formData as CreateL86RecordInput);
      onSuccess(record);
    } catch (error) {
