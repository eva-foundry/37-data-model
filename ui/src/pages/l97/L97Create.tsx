/**
 * L97CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L97 (l97)
 * Generated: 2026-03-13T07:20:29.9821832-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l97 records with validation and error handling.
 * 
 * Features:
...
import { createL97Record } from '@api/l97Api';
import type { L97Record, CreateL97RecordInput } from '@/types/l97';

interface L97CreateFormProps {
...
export const L97CreateForm: React.FC<L97CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l97.create_form');

  const [formData, setFormData] = useState<Partial<CreateL97RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL97Record(formData as CreateL97RecordInput);
      onSuccess(record);
    } catch (error) {
