/**
 * L79CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L79 (l79)
 * Generated: 2026-03-13T07:20:28.6957338-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l79 records with validation and error handling.
 * 
 * Features:
...
import { createL79Record } from '@api/l79Api';
import type { L79Record, CreateL79RecordInput } from '@/types/l79';

interface L79CreateFormProps {
...
export const L79CreateForm: React.FC<L79CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l79.create_form');

  const [formData, setFormData] = useState<Partial<CreateL79RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL79Record(formData as CreateL79RecordInput);
      onSuccess(record);
    } catch (error) {
