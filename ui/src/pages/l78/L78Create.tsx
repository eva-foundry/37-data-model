/**
 * L78CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L78 (l78)
 * Generated: 2026-03-13T07:20:28.6342726-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l78 records with validation and error handling.
 * 
 * Features:
...
import { createL78Record } from '@api/l78Api';
import type { L78Record, CreateL78RecordInput } from '@/types/l78';

interface L78CreateFormProps {
...
export const L78CreateForm: React.FC<L78CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l78.create_form');

  const [formData, setFormData] = useState<Partial<CreateL78RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL78Record(formData as CreateL78RecordInput);
      onSuccess(record);
    } catch (error) {
