/**
 * L81CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L81 (l81)
 * Generated: 2026-03-13T07:20:28.8832518-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l81 records with validation and error handling.
 * 
 * Features:
...
import { createL81Record } from '@api/l81Api';
import type { L81Record, CreateL81RecordInput } from '@/types/l81';

interface L81CreateFormProps {
...
export const L81CreateForm: React.FC<L81CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l81.create_form');

  const [formData, setFormData] = useState<Partial<CreateL81RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL81Record(formData as CreateL81RecordInput);
      onSuccess(record);
    } catch (error) {
