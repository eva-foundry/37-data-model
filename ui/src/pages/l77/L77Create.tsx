/**
 * L77CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L77 (l77)
 * Generated: 2026-03-13T07:20:28.5721265-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l77 records with validation and error handling.
 * 
 * Features:
...
import { createL77Record } from '@api/l77Api';
import type { L77Record, CreateL77RecordInput } from '@/types/l77';

interface L77CreateFormProps {
...
export const L77CreateForm: React.FC<L77CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l77.create_form');

  const [formData, setFormData] = useState<Partial<CreateL77RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL77Record(formData as CreateL77RecordInput);
      onSuccess(record);
    } catch (error) {
