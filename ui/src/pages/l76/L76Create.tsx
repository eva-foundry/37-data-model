/**
 * L76CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L76 (l76)
 * Generated: 2026-03-13T07:20:28.5072641-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l76 records with validation and error handling.
 * 
 * Features:
...
import { createL76Record } from '@api/l76Api';
import type { L76Record, CreateL76RecordInput } from '@/types/l76';

interface L76CreateFormProps {
...
export const L76CreateForm: React.FC<L76CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l76.create_form');

  const [formData, setFormData] = useState<Partial<CreateL76RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL76Record(formData as CreateL76RecordInput);
      onSuccess(record);
    } catch (error) {
