/**
 * L99CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L99 (l99)
 * Generated: 2026-03-13T07:20:30.1158120-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l99 records with validation and error handling.
 * 
 * Features:
...
import { createL99Record } from '@api/l99Api';
import type { L99Record, CreateL99RecordInput } from '@/types/l99';

interface L99CreateFormProps {
...
export const L99CreateForm: React.FC<L99CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l99.create_form');

  const [formData, setFormData] = useState<Partial<CreateL99RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL99Record(formData as CreateL99RecordInput);
      onSuccess(record);
    } catch (error) {
