/**
 * L85CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L85 (l85)
 * Generated: 2026-03-13T07:20:29.1405996-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l85 records with validation and error handling.
 * 
 * Features:
...
import { createL85Record } from '@api/l85Api';
import type { L85Record, CreateL85RecordInput } from '@/types/l85';

interface L85CreateFormProps {
...
export const L85CreateForm: React.FC<L85CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l85.create_form');

  const [formData, setFormData] = useState<Partial<CreateL85RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL85Record(formData as CreateL85RecordInput);
      onSuccess(record);
    } catch (error) {
