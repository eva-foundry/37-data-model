 ...
 * Generated: 2026-03-13T07:20:25.2139298-03:00
...
import type { L30Record, CreateL30RecordInput } from '@/types/risks';
...
export const RisksCreateForm: React.FC<RisksCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL30RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createRisksRecord(formData as CreateL30RecordInput);
      onSuccess(record);
    } catch (error) {
