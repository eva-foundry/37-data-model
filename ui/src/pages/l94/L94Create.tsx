/**
 * L94CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L94 (l94)
 * Generated: 2026-03-13T07:20:29.7925171-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l94 records with validation and error handling.
 * 
 * Features:
...
import { createL94Record } from '@api/l94Api';
import type { L94Record, CreateL94RecordInput } from '@/types/l94';

interface L94CreateFormProps {
...
export const L94CreateForm: React.FC<L94CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l94.create_form');

  const [formData, setFormData] = useState<Partial<CreateL94RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL94Record(formData as CreateL94RecordInput);
      onSuccess(record);
    } catch (error) {
