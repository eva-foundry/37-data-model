/**
 * L98CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L98 (l98)
 * Generated: 2026-03-13T07:20:30.0473322-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l98 records with validation and error handling.
 * 
 * Features:
...
import { createL98Record } from '@api/l98Api';
import type { L98Record, CreateL98RecordInput } from '@/types/l98';

interface L98CreateFormProps {
...
export const L98CreateForm: React.FC<L98CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l98.create_form');

  const [formData, setFormData] = useState<Partial<CreateL98RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL98Record(formData as CreateL98RecordInput);
      onSuccess(record);
    } catch (error) {
