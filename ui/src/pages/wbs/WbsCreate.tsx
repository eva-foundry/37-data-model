 ...
 * Generated: 2026-03-13T07:20:24.9324704-03:00
...
import type { L27Record, CreateL27RecordInput } from '@/types/wbs';
...
export const WbsCreateForm: React.FC<WbsCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL27RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createWbsRecord(formData as CreateL27RecordInput);
      onSuccess(record);
    } catch (error) {
