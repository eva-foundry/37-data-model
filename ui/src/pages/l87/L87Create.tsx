/**
 * L87CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L87 (l87)
 * Generated: 2026-03-13T07:20:29.2729054-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l87 records with validation and error handling.
 * 
 * Features:
...
import { createL87Record } from '@api/l87Api';
import type { L87Record, CreateL87RecordInput } from '@/types/l87';

interface L87CreateFormProps {
...
export const L87CreateForm: React.FC<L87CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l87.create_form');

  const [formData, setFormData] = useState<Partial<CreateL87RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL87Record(formData as CreateL87RecordInput);
      onSuccess(record);
    } catch (error) {
