/**
 * L89CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L89 (l89)
 * Generated: 2026-03-13T07:20:29.3975803-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l89 records with validation and error handling.
 * 
 * Features:
...
import { createL89Record } from '@api/l89Api';
import type { L89Record, CreateL89RecordInput } from '@/types/l89';

interface L89CreateFormProps {
...
export const L89CreateForm: React.FC<L89CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l89.create_form');

  const [formData, setFormData] = useState<Partial<CreateL89RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL89Record(formData as CreateL89RecordInput);
      onSuccess(record);
    } catch (error) {
