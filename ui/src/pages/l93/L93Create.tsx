/**
 * L93CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L93 (l93)
 * Generated: 2026-03-13T07:20:29.7279853-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l93 records with validation and error handling.
 * 
 * Features:
...
import { createL93Record } from '@api/l93Api';
import type { L93Record, CreateL93RecordInput } from '@/types/l93';

interface L93CreateFormProps {
...
export const L93CreateForm: React.FC<L93CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l93.create_form');

  const [formData, setFormData] = useState<Partial<CreateL93RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL93Record(formData as CreateL93RecordInput);
      onSuccess(record);
    } catch (error) {
