 ...
 * Generated: 2026-03-13T07:20:24.8678668-03:00
...
import type { L26Record, CreateL26RecordInput } from '@/types/projects';
...
export const ProjectsCreateForm: React.FC<ProjectsCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL26RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createProjectsRecord(formData as CreateL26RecordInput);
      onSuccess(record);
    } catch (error) {
