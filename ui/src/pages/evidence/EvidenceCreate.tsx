 ...
 * Generated: 2026-03-13T07:20:25.4089050-03:00
...
import type { L33Record, CreateL33RecordInput } from '@/types/evidence';
...
export const EvidenceCreateForm: React.FC<EvidenceCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL33RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createEvidenceRecord(formData as CreateL33RecordInput);
      onSuccess(record);
    } catch (error) {
