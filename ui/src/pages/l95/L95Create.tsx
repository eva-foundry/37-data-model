/**
 * L95CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L95 (l95)
 * Generated: 2026-03-13T07:20:29.8569012-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l95 records with validation and error handling.
 * 
 * Features:
...
import { createL95Record } from '@api/l95Api';
import type { L95Record, CreateL95RecordInput } from '@/types/l95';

interface L95CreateFormProps {
...
export const L95CreateForm: React.FC<L95CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l95.create_form');

  const [formData, setFormData] = useState<Partial<CreateL95RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL95Record(formData as CreateL95RecordInput);
      onSuccess(record);
    } catch (error) {
