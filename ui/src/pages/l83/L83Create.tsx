/**
 * L83CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L83 (l83)
 * Generated: 2026-03-13T07:20:29.0093323-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l83 records with validation and error handling.
 * 
 * Features:
...
import { createL83Record } from '@api/l83Api';
import type { L83Record, CreateL83RecordInput } from '@/types/l83';

interface L83CreateFormProps {
...
export const L83CreateForm: React.FC<L83CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l83.create_form');

  const [formData, setFormData] = useState<Partial<CreateL83RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL83Record(formData as CreateL83RecordInput);
      onSuccess(record);
    } catch (error) {
