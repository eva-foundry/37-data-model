 ...
 * Generated: 2026-03-13T07:20:22.6959054-03:00
...
import type { L1Record, CreateL1RecordInput } from '@/types/services';
...
export const ServicesCreateForm: React.FC<ServicesCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL1RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createServicesRecord(formData as CreateL1RecordInput);
      onSuccess(record);
    } catch (error) {
