/**
 * L84CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L84 (l84)
 * Generated: 2026-03-13T07:20:29.0713413-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l84 records with validation and error handling.
 * 
 * Features:
...
import { createL84Record } from '@api/l84Api';
import type { L84Record, CreateL84RecordInput } from '@/types/l84';

interface L84CreateFormProps {
...
export const L84CreateForm: React.FC<L84CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l84.create_form');

  const [formData, setFormData] = useState<Partial<CreateL84RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL84Record(formData as CreateL84RecordInput);
      onSuccess(record);
    } catch (error) {
