/**
 * L96CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L96 (l96)
 * Generated: 2026-03-13T07:20:29.9201462-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l96 records with validation and error handling.
 * 
 * Features:
...
import { createL96Record } from '@api/l96Api';
import type { L96Record, CreateL96RecordInput } from '@/types/l96';

interface L96CreateFormProps {
...
export const L96CreateForm: React.FC<L96CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l96.create_form');

  const [formData, setFormData] = useState<Partial<CreateL96RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL96Record(formData as CreateL96RecordInput);
      onSuccess(record);
    } catch (error) {
