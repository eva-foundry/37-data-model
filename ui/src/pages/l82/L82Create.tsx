/**
 * L82CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L82 (l82)
 * Generated: 2026-03-13T07:20:28.9468144-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l82 records with validation and error handling.
 * 
 * Features:
...
import { createL82Record } from '@api/l82Api';
import type { L82Record, CreateL82RecordInput } from '@/types/l82';

interface L82CreateFormProps {
...
export const L82CreateForm: React.FC<L82CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l82.create_form');

  const [formData, setFormData] = useState<Partial<CreateL82RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL82Record(formData as CreateL82RecordInput);
      onSuccess(record);
    } catch (error) {
