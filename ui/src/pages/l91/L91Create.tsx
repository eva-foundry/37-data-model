/**
 * L91CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L91 (l91)
 * Generated: 2026-03-13T07:20:29.6012634-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l91 records with validation and error handling.
 * 
 * Features:
...
import { createL91Record } from '@api/l91Api';
import type { L91Record, CreateL91RecordInput } from '@/types/l91';

interface L91CreateFormProps {
...
export const L91CreateForm: React.FC<L91CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l91.create_form');

  const [formData, setFormData] = useState<Partial<CreateL91RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL91Record(formData as CreateL91RecordInput);
      onSuccess(record);
    } catch (error) {
