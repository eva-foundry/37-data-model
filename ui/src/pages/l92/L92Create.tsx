/**
 * L92CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L92 (l92)
 * Generated: 2026-03-13T07:20:29.6624682-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l92 records with validation and error handling.
 * 
 * Features:
...
import { createL92Record } from '@api/l92Api';
import type { L92Record, CreateL92RecordInput } from '@/types/l92';

interface L92CreateFormProps {
...
export const L92CreateForm: React.FC<L92CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l92.create_form');

  const [formData, setFormData] = useState<Partial<CreateL92RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL92Record(formData as CreateL92RecordInput);
      onSuccess(record);
    } catch (error) {
