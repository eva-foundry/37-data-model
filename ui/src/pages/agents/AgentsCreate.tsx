 ...
 * Generated: 2026-03-13T07:20:29.4624123-03:00
...
import type { L9Record, CreateL9RecordInput } from '@/types/agents';
...
export const AgentsCreateForm: React.FC<AgentsCreateFormProps> = ({ onSuccess, onCancel }) => {
  ...
  const [formData, setFormData] = useState<Partial<CreateL9RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createAgentsRecord(formData as CreateL9RecordInput);
      onSuccess(record);
    } catch (error) {
