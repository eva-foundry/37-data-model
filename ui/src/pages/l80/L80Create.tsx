/**
 * L80CreateForm -- Auto-generated by Screens Machine v1.0.0
 * 
 * Data Model Layer: L80 (l80)
 * Generated: 2026-03-13T07:20:28.8195892-03:00
 * Generator: screens-machine-v2.0.0
 * 
 * Form for creating new l80 records with validation and error handling.
 * 
 * Features:
...
import { createL80Record } from '@api/l80Api';
import type { L80Record, CreateL80RecordInput } from '@/types/l80';

interface L80CreateFormProps {
...
export const L80CreateForm: React.FC<L80CreateFormProps> = ({ onSuccess, onCancel }) => {
  const t = useLiterals('l80.create_form');

  const [formData, setFormData] = useState<Partial<CreateL80RecordInput>>({});
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const record = await createL80Record(formData as CreateL80RecordInput);
      onSuccess(record);
    } catch (error) {
