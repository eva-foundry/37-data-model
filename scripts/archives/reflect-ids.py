...
in PLAN.md with its canonical Veritas ID in square brackets:
  ...
  BEFORE:  Story 1.2.3  As the system, after mark_collection_complete...
  AFTER:   Story 1.2.3 [F37-02-017]  As the system, after mark_collection_complete...
...
New-format stories (Story F37-NN-NNN  title) are left unchanged.
...
#   "  Story F37-02-017  title..."
STORY_NEW_RE = re.compile(r"^\s{2,6}Story\s+(F37-\d{2}-\d{3})\s{2,}")
